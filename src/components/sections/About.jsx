        ...
        <div className="max-w-3xl mx-auto px-4 ">
          ...
          <div className="rounded-xl p-8 border-white/10 border hover:-translate-y-1 transition-all hover:bg-pink-200/70 cursor-default hover:shadow-xl">
            <p className="text-black mb-6 cursor-default">
              I am passionate about game development and I deeply enjoy the process of creating games and websites. 
              The process of creating a game including the debugging and rewriting process entertains me. I enjoy 
              creating unique websites for personal or work use. 
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="rounded-xl p-6 hover:-translate-y-1 transition-all">
                <h3 className="text-xl font-bold text-black mb-4 cursor-default">Frontend</h3>
              ...
              <div className="rounded-xl p-6 hover:-translate-y-1 transition-all">
                <h3 className="text-xl font-bold text-black mb-4 cursor-default">Backend</h3>
                <div className="flex flex-wrap gap-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8 ">
            <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all hover:bg-pink-200/70 hover:shadow-xl">
              <h3 className="text-xl font-bold mb-4 text-black cursor-default">Education</h3>
            ...
            <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all hover:bg-pink-200/70 hover:shadow-xl">
              <h3 className="text-xl font-bold mb-4 text-black cursor-default">Work Experience</h3>
