      ...
      >
        <RevealOnScroll>
          <div className="text-center z-10 px-4">
            <h1 className="text-5xl md:text-7xl font-bold h-20 mb-6 bg-gradient-to-r from-pink-300 to-rose-400 bg-clip-text text-transparent leading-right">
              Hey, I'm Jaycee
            </h1>
            <p className="text-black text-lg mb-8 max-w-lg mx-auto">
              I'm a full-stack Web Developer that has developed a multitude of
              projects working in the front-end, back-end, and with web design.
              I have worked with a small variety of languages but mostly in
              Javascript.
            </p>
